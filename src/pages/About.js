      ...
      <div className="container">
        <div className="top-section">
          <div className="left">
            <p className="about__subheading">
              Hi, I am <span className="">Thanh Tú</span>
        ...
        <div className="about__info__items">
          <div className="about__info__item">
            ...
            <AboutInfoItem
              title="School"
              items={['Duy Tan University, Đa Nang']}
            />
            <AboutInfoItem title="College" items={['Duy Tan University']} />
            <AboutInfoItem title="Science" items={['Information Technology']} />
          </div>
          <div className="about__info__item">
